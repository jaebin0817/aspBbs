<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TestRead.aspx.cs" Inherits="WebApplication1.TestRead" %>
                    ...
                    <ItemTemplate>
                            <tr>                          
                                <td>
                                    ...
                                    <a href="TestPwcheck.aspx?mode=r_mod&r_no=<%# Eval("r_no") %>">
                                        <%# Eval("r_wname").ToString() !="" ? "수정" : "" %></a>&nbsp;
                                    <a href="TestPwcheck.aspx?mode=r_del&r_no=<%# Eval("r_no") %>">

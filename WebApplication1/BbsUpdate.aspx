<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BbsUpdate.aspx.cs" Inherits="WebApplication1.BbsUpdate" %>
        ...
        <div class="page-title" id="page-title">게시글 작성</div>
          <table class="table write-form">
              ...
              <tr>
                   <th>게시글 공개</th>
                   <td>
                        <asp:RadioButton ID="p_open_y" GroupName="p_open" Text="공개" runat="server" />
